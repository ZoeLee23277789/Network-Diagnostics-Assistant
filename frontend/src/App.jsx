...
import ConnectivityTestPage from './pages/ConnectivityTestPage.jsx'
import {
  ResponsiveContainer,
  LineChart,
  Line,
      ...
      <main className="main">
        <div className="header-row page-header">
          ...
          <div className="view-tabs">
            ...
            <button
              type="button"
              className={`tab-button ${mainView === 'connectivity' ? 'active' : ''}`}
              onClick={() => setMainView('connectivity')}
            >
              Connectivity Tests
            </button>
          </div>
